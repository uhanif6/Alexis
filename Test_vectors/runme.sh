...
HD_PWD='C:/Users/e0974166/Test_vectors/Test_vectors.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log assign_2_fault.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source assign_2_fault.tcl -notrace
